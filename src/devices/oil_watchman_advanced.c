...
static int oil_watchman_advanced_decode(r_device *decoder, bitbuffer_t *bitbuffer)
{
    ...
    while ((bitpos = bitbuffer_search(bitbuffer, 0, bitpos, preamble_pattern, PREAMBLE_SYNC_LENGTH_BITS + HEADER_LENGTH_BITS)) + BODY_LENGTH_BITS <=
        ...
        data_t *data = data_make(
                ...
                "b00",                  "Byte00",       DATA_FORMAT, "%02x", DATA_INT, b[0],
                "b01",                  "Byte01",       DATA_FORMAT, "%02x", DATA_INT, b[1],
                "b02",                  "Byte02",       DATA_FORMAT, "%02x", DATA_INT, b[2],
                "b03",                  "Byte03",       DATA_FORMAT, "%02x", DATA_INT, b[3],
                "b04",                  "Byte04",       DATA_FORMAT, "%02x", DATA_INT, b[4],
                "b05",                  "Byte05",       DATA_FORMAT, "%02x", DATA_INT, b[5],
                "b06",                  "Byte06",       DATA_FORMAT, "%02x", DATA_INT, b[6],
                "b07",                  "Byte07",       DATA_FORMAT, "%02x", DATA_INT, b[7],
                "b08",                  "Byte08",       DATA_FORMAT, "%02x", DATA_INT, b[8],
                "b09",                  "Byte09",       DATA_FORMAT, "%02x", DATA_INT, b[9],
                "b10",                  "Byte10",       DATA_FORMAT, "%02x", DATA_INT, b[10],
                "b11",                  "Byte11",       DATA_FORMAT, "%02x", DATA_INT, b[11],
                "b12",                  "Byte12",       DATA_FORMAT, "%02x", DATA_INT, b[12],
                "b13",                  "Byte13",       DATA_FORMAT, "%02x", DATA_INT, b[13],
                "b14",                  "Byte14",       DATA_FORMAT, "%02x", DATA_INT, b[14],
